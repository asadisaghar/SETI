...
#log = np.loadtxt('single_4.txt')
log = np.loadtxt('logfile.txt')
...
#plt.legend(loc='center', bbox_to_anchor=(3000, 0.5), frameon=False, fontsize=20)

plt.title('Single probe\n', fontsize=20)
plt.text(x=5555, y=0.365, s='$V_{probe} = 0.1 c$\n $dt_{const} = 1$ $yr$\n', fontsize=22)
plt.show()
#plt.savefig('/home/saas9842/Dropbox/SETI_report/Figs4/single_6.png')
